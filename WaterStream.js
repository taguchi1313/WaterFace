class WaterStream {
  constructor(x, y, type, weight, sp) {
//--------------------------
// フェーズ判定用ステータス
//--------------------------
...
//--------------------------
    ...
    // カーブの半径
    this.radius = random([15,20,50,75]);
//--------------------------
// 分岐
//--------------------------
    switch(type) {
      ...
      case "branch":
        ...
        this.moveCountTarget = random([50,100,200]);
        this.sp = sp;
    }
    ...
    switch(this.moveState){
      ...
      case "curveDown":
        ...
        if (this.angle < 0 || this.angle > 180) {
          ...
          this.moveCount = 0;
          this.moveCountTarget = random(50,200);
          this.radius = 10;
          this.LR *= -1;
          this.moveState = "down";
        }
...
//--------------------------
  extend() {
    let count = this.extendCount/this.extendSp;
    this.cB = 100 - count*count * 100;
